...
var Tab = /** @class */ (function (_super) {
    ...
    Tab.prototype.SetVisibilities = function (value, callback) {
...
var Tabs = /** @class */ (function (_super) {
    ...
    function Tabs(_a) {
        ...
        _this.mRefDiv = React.createRef(); // React.RefObject;
        _this.list = [];
        _this._id = v4();
        return _this;
    }
    ...
    Tabs.prototype.innerRender = function () {
        ...
        if (reactExports.Children) {
            this.list = [];
            React.Children.map(this.props.children, function (d) {
                var element = d;
    ...
    Tabs.prototype.render = function () {
        var _this = this;
        this.innerRender();
        return (React.createElement("div", { ref: this.mRefDiv, className: this.props.className, style: this.props.style, id: this.props.id },
